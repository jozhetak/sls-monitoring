        ...
        it('Should be able to collect correct data', () => {
            ...
            return collector
                ...
                .then((functions) => {
                    ...
                    const noLogStreamLambda = _.find(functions, f => f.FunctionName === 'Lambda2-no-log-streams');
                    noLogStreamLambda.invocations.should.be.instanceof(Array).and.have.lengthOf(0);
        ...
        it('Should correctly collect errors from logs', () => {
            ...
            return collector
                ...
                .then((functions) => {
                    ...
                    const lambda1 = _.find(functions, f => f.FunctionName === 'Lambda1-errors');
                    ...
                    const lambda2 = _.find(functions, f => f.FunctionName === 'Lambda2-errors');
